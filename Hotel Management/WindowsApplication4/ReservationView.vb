...
Public Class ReservationViewFRM
    ...
    Private Sub ReservationViewFRM_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Me.ReservationView.ClearSelection()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles BtnUpdate.Click
        ...
        Try
            ...
            MsgBox("Record Successfully Updated", , "Update Reservation")
            Call clear()
        Catch ex As Exception
            MsgBox(ex.ToString)
        End Try
    ...
    Private Sub NoEntry()
        If (Me.ReservationView.SelectedRows.Count > 0) And (Me.statusTxt.SelectedIndex <> -1) Then
    ...
    Private Sub ReservationView_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles ReservationView.CellContentClick
        Call NoEntry()
    End Sub
